...
<head>
    ...
    <title> Instalación - TPO Ver. <?php echo cmsVersion; ?></title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">Instalación</a>
            </div>
            <div class="navbar-collapse collapse">

                <ul class="nav navbar-nav pull-right">
                    <li><a href="http://inicio.ifai.org.mx/SitePages/ifai.aspx" target="_inai">INAI</a></li>
                    <li><a href="http://fundar.org.mx/" target="_fundar">FUNDAR </a></li>
                </ul>
            </div>
        </div>
    </div>
