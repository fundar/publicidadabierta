...
<div class="theWell clearfix">
    <div class="page-header">
        <h1>Condiciones de uso y licenciamiento <small>Léeme</small></h1>
    </div>

    <div class="clearfix theInner">

        <div class="clearfix thatHeader">
            <h3 class="theHeading">Acuerdo de licencia</h3>
            <p class="lead">
                Texto de licenciamiento....
            </p>
        </div>

    </div>
    <a href="?step1=1" class="btn btn-lg thatBtn btn-default pull-left">Regresar</a>

    <a href="?step=2" class="btn btn-lg thatBtn btn-success pull-right">Acepto</a>
</div>
