...
/*
    public static $dbname = 'itbackco_tpo'; // Your database name
    public static $dbuser = 'itbackco_tpo'; // Your database username
    public static $dbpass = 'MyTpo7*-'; // // Your database password
    public static $dbhost = '127.0.0.1'; // Your database host, 'localhost' is default.

Server  
    'hostname' => 'p3plcpnl0512.prod.phx3.secureserver.net',
	'username' => 'dbusringestec',
	'password' => 'Usr7*-',
	'database' => 'ingestectiv1',
	'dbdriver' => 'mysqli',
