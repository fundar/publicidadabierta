...
//ult $xcrud->relation('tab_facturas.id_contrato','tab_contratos','id_contrato','numero_contrato','','','','','','id_ejercicio','id_ejercicio');
      $xcrud->relation('tab_facturas.id_contrato','tab_contratos','id_contrato','numero_contrato'); 
...
/*
    ...
    $detalle->relation('id_servicio_clasificacion','cat_servicios_clasificacion','id_servicio_clasificacion', 'nombre_servicio_clasificacion');	
    $detalle->relation('id_servicio_categoria','cat_servicios_categorias','id_servicio_categoria','nombre_servicio_categoria',
                        'id_servicio_categoria="{id_servicio_categoria}"','','',' ','','id_servicio_clasificacion','id_servicio_clasificacion');
    $detalle->relation('id_servicio_subcategoria','cat_servicios_subcategorias','id_servicio_subcategoria','nombre_servicio_subcategoria',
                       'id_servicio_subcategoria="{id_servicio_subcategoria}"', '', '', '', '', 'id_servicio_categoria','id_servicio_categoria');
    $detalle->relation('id_servicio_unidad','cat_servicios_unidades','id_servicio_unidad','nombre_servicio_unidad',
                        'id_servicio_unidad="{id_servicio_unidad}"', '', '', '', '', 'id_servicio_subcategoria','id_servicio_subcategoria');     
