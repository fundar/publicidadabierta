...
');
    ...
    $detalle->relation('id_campana_aviso','tab_campana_aviso','id_campana_aviso','nombre_campana_aviso', 
              'id_ejercicio = (select b.id_ejercicio from tab_facturas_desglose as a, tab_facturas as b where a.id_factura = b.id_factura and //a.id_factura_desglose = "{id_factura_desglose}")');
