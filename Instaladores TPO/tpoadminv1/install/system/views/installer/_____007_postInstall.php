...
<div class="theWell">
    ...
    <div class="clearfix">
        ...
        <div class="thatInstall">
            ...
            <p class="messageBlock">¡Utilizar las credenciales de inicio de sesión para acceder al sistema!</p>
        </div>

        <div class="clearfix theInner">
            <div class="clearfix thatHeader">
                <h3 class="theHeading">Las credenciales del administrador son:</h3>
                </p>
            </div>

            <div class="clearfix">
                <p class="lead"> Usuario: <?php echo $_SESSION['install_userName']; ?> </p>
                <p class="lead"> Clave: <?php echo $_SESSION['install_newPassword']; ?> </p>
            </div>

            <div class="clearfix thatHeader">
                <h3 class="theHeading">URL del módulo:</h3>
                <p class="lead">
                    El módulo ha sido instalado en la URL: <a href="<?php echo URL_BASE; ?>" target="_sistema"><?php echo URL_BASE; ?></a>
                </p>
            </div>
            <div class="clearfix">
