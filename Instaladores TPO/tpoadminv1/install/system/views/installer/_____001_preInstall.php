...
<div class="theWell">
    ...
    <div class="jumbotron">
        ...
        <center>
        <p>Instalación del módulo "TPO Admin", Ver. <?php echo cmsVersion; ?></p>
    </div>
    ...
    <div class="clearfix theInner">
        ...
        <div class="col-lg-12 upperBlock paddingBlock">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <?php ifWritable( 'data');?>
                <?php ifWritable( 'data/campanas');?>
                <?php ifWritable( 'data/convenios');?>
                <?php ifWritable( 'data/facturas');?>
                <?php ifWritable( 'data/ordenes');?>
                <?php ifWritable( 'data/programas');?>
